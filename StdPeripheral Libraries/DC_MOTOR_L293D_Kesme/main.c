...
void motor1Init(GPIO_TypeDef* port, uint16_t forwardPin, uint16_t backwardPin){
...
void EXTI9_5_IRQHandler(){
   if(EXTI_GetITStatus(EXTI_Line6)!=RESET){
		goBackward(portB,pin0,pin1,250);
		delay(36000000);
...
int main(){
	extiConfig();
	motor1Init(portB,pin0,pin1);
	
	while(1){
		goForward(portB,pin0,pin1,250);
