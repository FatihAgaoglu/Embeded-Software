...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
    ...
    /* USER CODE BEGIN 3 */
		switchValue = HAL_GPIO_ReadPin(switch_GPIO_Port, switch_Pin);
		encValue = (TIM1->CNT) >> 2;
